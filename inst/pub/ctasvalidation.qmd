...
Ensuring the high quality of data is a major resonpsibility of the clinical trial sponsor. Current ICH guidelines recommended a risk-based statistical approach to monitor the completeness, expected range and variablity of the clinical trial data @noauthor_ich_1997 So called central monitoring activities are part of the risk-based quality monitoring (RBQM) framework one of which is statistical data monitoring (SDM).
