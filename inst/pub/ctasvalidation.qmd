...
- Autocorrelation (Correlation with preceeding value)
- Average Value
- Standard Deviation
- Range
- Unique Value Ratio (Number of unique values divided by number of values available)
- Local Outlier Factor (Local deviation of a given data point with respect to its neighbours) @breunig_lof_2000

> BK: the illustration lacks range and local outlier factor
